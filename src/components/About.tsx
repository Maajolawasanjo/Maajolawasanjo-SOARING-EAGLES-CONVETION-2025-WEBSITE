    ...
    <section id="about" className="py-12 md:py-20 px-4 md:px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10 md:mb-14">
          ...
          <h2 className="text-blue-950 mb-6 md:mb-8 text-3xl sm:text-4xl md:text-5xl lg:text-6xl px-4" data-aos="fade-up" data-aos-delay="100">
            Two Nights of
            <span className="block mt-2 bg-gradient-to-r from-amber-500 to-amber-600 bg-clip-text text-transparent">
              Divine Encounter
            </span>
          </h2>
          <div className="max-w-3xl mx-auto space-y-4 md:space-y-6 text-blue-900/70 text-base md:text-lg leading-relaxed px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {features.map((feature, idx) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-amber-400 to-amber-500 rounded-2xl mb-5 md:mb-6 group-hover:scale-110 transition-transform shadow-lg">
                <feature.icon className="size-7 md:size-8 text-white" />
              </div>
              <h3 className="text-blue-950 mb-2 md:mb-3 text-lg md:text-xl">{feature.title}</h3>
              <p className="text-blue-900/60 leading-relaxed text-sm md:text-base">
                {feature.description}
              </p>
            </div>
          ))}
        ...
        <div className="mt-12 md:mt-16 text-center px-4" data-aos="zoom-in" data-aos-delay="800">
          <div className="inline-flex items-center gap-3 px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-blue-950 to-blue-900 text-white rounded-full shadow-2xl text-sm md:text-lg">
